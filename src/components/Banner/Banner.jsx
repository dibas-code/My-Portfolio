        ...
        <div style={bgGrains} className="bg-gray-950 rounded-3xl py-14 px-5 md:px-10 grid grid-cols-1 md:grid-cols-2 space-y-6 md:space-y-0 translate-y-36">
          ...
          <div className="flex flex-col justify-center ">
            <div className="text-left space-y-7 lg:max-w-[400px]">
              ...
              <div className="flex items-center justify-evenly md:justify-center gap-2 md:gap-4">
                ...
                <motion.button variants={slideUp(0.5)} whileInView="animate" initial="initial" className="border border-white/50 rounded-lg md:px-3 flex items-center gap-2 sm:py-3"><a href="./Resume.pdf" className="py-3 px-4 flex items-center gap-2 text-xs md:text-base"><FiDownload />Download Resume</a></motion.button>
              </div>
            </div>
          </div>
        </div>
